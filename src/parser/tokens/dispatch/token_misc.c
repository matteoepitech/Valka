/*
** VALKA PROJECT, 2025
** src/parser/tokens/dispatch/token_misc
** File description:
** Token misc (@)
*/
 ...
 */
parsing_src_file_t *
misc_token(parsing_src_file_t *p)
{
    ...
    token = create_token(TOKEN_MISC, start, length, p->_current_loc);
