/*
** VALKA PROJECT, 2025
** src/parser/tokens/dispatch/token_comma
** File description:
** Token comma
*/
 ...
 */
parsing_src_file_t *
comma_token(parsing_src_file_t *p)
{
    ...
    token = create_token(TOKEN_COMMA, start, length, p->_current_loc);
